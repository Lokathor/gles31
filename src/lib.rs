// file generated by `phosphorus-2.0.2`
// Args { xml: "gl-2022-10-27.xml", api: "gles2", name: "GL_ES_VERSION_3_1",
// number: "3.1", ext: ["GL_KHR_debug"] }
...
pub unsafe fn glActiveShaderProgram(pipeline: GLuint, program: GLuint) -> () {
  let u: usize =
    glActiveShaderProgram_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glBindImageTexture(
  unit: GLuint, texture: GLuint, level: GLint, layered: GLboolean,
  layer: GLint, access: GLenum, format: GLenum,
) -> () {
  let u: usize =
    glBindImageTexture_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLuint,
...
pub unsafe fn glBindProgramPipeline(pipeline: GLuint) -> () {
  let u: usize =
    glBindProgramPipeline_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glBindTransformFeedback(target: GLenum, id: GLuint) -> () {
  let u: usize =
    glBindTransformFeedback_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLenum, GLuint) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(target, id)
...
pub unsafe fn glBindVertexBuffer(
  ...
  let u: usize =
    glBindVertexBuffer_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLuint,
...
static glClearDepthf_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
...
pub unsafe fn glCreateShaderProgramv(
  type_: GLenum, count: GLsizei, strings: *const *const GLchar,
) -> GLuint {
  let u: usize =
    glCreateShaderProgramv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLsizei,
...
static glDebugMessageCallbackKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glDebugMessageCallbackKHR(
  callback: GLDEBUGPROCKHR, userParam: *const void,
) -> () {
  let u: usize =
    glDebugMessageCallbackKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLDEBUGPROCKHR, *const void) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(callback, userParam)
}

static glDebugMessageControlKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glDebugMessageControlKHR(
  ...
  let u: usize =
    glDebugMessageControlKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLenum,
...
static glDebugMessageInsertKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glDebugMessageInsertKHR(
  ...
  let u: usize =
    glDebugMessageInsertKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLenum,
...
static glDeleteProgramPipelines_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glDeleteProgramPipelines(
  n: GLsizei, pipelines: *const GLuint,
) -> () {
  let u: usize =
    glDeleteProgramPipelines_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLsizei, *const GLuint) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(n, pipelines)
...
pub unsafe fn glDeleteTransformFeedbacks(n: GLsizei, ids: *const GLuint) -> () {
  let u: usize =
    glDeleteTransformFeedbacks_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLsizei, *const GLuint) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(n, ids)
...
static glDepthRangef_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
...
pub unsafe fn glDispatchCompute(
  ...
  let u: usize =
    glDispatchCompute_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glDispatchComputeIndirect(indirect: GLintptr) -> () {
  let u: usize =
    glDispatchComputeIndirect_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLintptr) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(indirect)
}
...
pub unsafe fn glDrawArraysIndirect(mode: GLenum, indirect: *const void) -> () {
  let u: usize =
    glDrawArraysIndirect_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLenum, *const void) -> () =
    unsafe { core::mem::transmute(u) };
...
pub unsafe fn glDrawElementsIndirect(
  mode: GLenum, type_: GLenum, indirect: *const void,
) -> () {
  let u: usize =
    glDrawElementsIndirect_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLenum, GLenum, *const void) -> () =
    unsafe { core::mem::transmute(u) };
...
pub unsafe fn glFramebufferParameteri(
  ...
  let u: usize =
    glFramebufferParameteri_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glGenProgramPipelines(n: GLsizei, pipelines: *mut GLuint) -> () {
  let u: usize =
    glGenProgramPipelines_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLsizei, *mut GLuint) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(n, pipelines)
...
pub unsafe fn glGenTransformFeedbacks(n: GLsizei, ids: *mut GLuint) -> () {
  let u: usize =
    glGenTransformFeedbacks_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLsizei, *mut GLuint) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(n, ids)
...
static glGetDebugMessageLogKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glGetDebugMessageLogKHR(
  ...
  let u: usize =
    glGetDebugMessageLogKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLsizei,
...
pub unsafe fn glGetFramebufferParameteriv(
  ...
  let u: usize =
    glGetFramebufferParameteriv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLenum, GLenum, *mut GLint) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(target, pname, params)
...
pub unsafe fn glGetInternalformativ(
  target: GLenum, internalformat: GLenum, pname: GLenum, count: GLsizei,
  params: *mut GLint,
) -> () {
  let u: usize =
    glGetInternalformativ_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLenum,
...
static glGetObjectLabelKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glGetObjectLabelKHR(
  ...
  let u: usize =
    glGetObjectLabelKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLuint,
...
static glGetObjectPtrLabelKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glGetObjectPtrLabelKHR(
  ...
  let u: usize =
    glGetObjectPtrLabelKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    *const void,
    GLsizei,
...
static glGetPointervKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
...
pub unsafe fn glGetProgramBinary(
  ...
  binaryFormat: *mut GLenum, binary: *mut void,
) -> () {
  let u: usize =
    glGetProgramBinary_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLsizei,
...
pub unsafe fn glGetProgramInterfaceiv(
  ...
  let u: usize =
    glGetProgramInterfaceiv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLenum,
...
pub unsafe fn glGetProgramPipelineInfoLog(
  pipeline: GLuint, bufSize: GLsizei, length: *mut GLsizei,
  infoLog: *mut GLchar,
) -> () {
  let u: usize =
    glGetProgramPipelineInfoLog_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLsizei,
...
pub unsafe fn glGetProgramPipelineiv(
  pipeline: GLuint, pname: GLenum, params: *mut GLint,
) -> () {
  let u: usize =
    glGetProgramPipelineiv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glGetProgramResourceIndex(
  ...
  let u: usize =
    glGetProgramResourceIndex_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLenum,
...
pub unsafe fn glGetProgramResourceLocation(
  ...
  let u: usize =
    glGetProgramResourceLocation_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLenum,
    *const GLchar,
  ) -> GLint = unsafe { core::mem::transmute(u) };
  _func_p(program, programInterface, name)
}
...
pub unsafe fn glGetProgramResourceName(
  program: GLuint, programInterface: GLenum, index: GLuint, bufSize: GLsizei,
  length: *mut GLsizei, name: *mut GLchar,
) -> () {
  let u: usize =
    glGetProgramResourceName_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLenum,
...
pub unsafe fn glGetProgramResourceiv(
  program: GLuint, programInterface: GLenum, index: GLuint, propCount: GLsizei,
  props: *const GLenum, count: GLsizei, length: *mut GLsizei,
  params: *mut GLint,
) -> () {
  let u: usize =
    glGetProgramResourceiv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLenum,
...
pub unsafe fn glGetShaderPrecisionFormat(
  shadertype: GLenum, precisiontype: GLenum, range: *mut GLint,
  precision: *mut GLint,
) -> () {
  let u: usize =
    glGetShaderPrecisionFormat_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLenum,
...
pub unsafe fn glInvalidateFramebuffer(
  target: GLenum, numAttachments: GLsizei, attachments: *const GLenum,
) -> () {
  let u: usize =
    glInvalidateFramebuffer_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glInvalidateSubFramebuffer(
  ...
  let u: usize =
    glInvalidateSubFramebuffer_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLsizei,
...
pub unsafe fn glIsProgramPipeline(pipeline: GLuint) -> GLboolean {
  let u: usize =
    glIsProgramPipeline_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLuint) -> GLboolean =
    unsafe { core::mem::transmute(u) };
  _func_p(pipeline)
...
pub unsafe fn glIsTransformFeedback(id: GLuint) -> GLboolean {
  let u: usize =
    glIsTransformFeedback_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLuint) -> GLboolean =
    unsafe { core::mem::transmute(u) };
  _func_p(id)
...
static glMemoryBarrier_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
...
pub unsafe fn glMemoryBarrierByRegion(barriers: GLbitfield) -> () {
  let u: usize =
    glMemoryBarrierByRegion_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLbitfield) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(barriers)
...
static glObjectLabelKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
...
static glObjectPtrLabelKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glObjectPtrLabelKHR(
  ...
  let u: usize =
    glObjectPtrLabelKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    *const void,
    GLsizei,
...
pub unsafe fn glPauseTransformFeedback() -> () {
  let u: usize =
    glPauseTransformFeedback_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn() -> () =
    unsafe { core::mem::transmute(u) };
  _func_p()
...
static glPopDebugGroupKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glPopDebugGroupKHR() -> () {
  let u: usize =
    glPopDebugGroupKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn() -> () =
    unsafe { core::mem::transmute(u) };
  _func_p()
...
static glProgramBinary_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glProgramBinary(
  program: GLuint, binaryFormat: GLenum, binary: *const void, length: GLsizei,
) -> () {
...
pub unsafe fn glProgramParameteri(
  program: GLuint, pname: GLenum, value: GLint,
) -> () {
  let u: usize =
    glProgramParameteri_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glProgramUniform1f(
  program: GLuint, location: GLint, v0: GLfloat,
) -> () {
  let u: usize =
    glProgramUniform1f_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glProgramUniform1fv(
  program: GLuint, location: GLint, count: GLsizei, value: *const GLfloat,
) -> () {
  let u: usize =
    glProgramUniform1fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform1i(
  program: GLuint, location: GLint, v0: GLint,
) -> () {
  let u: usize =
    glProgramUniform1i_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glProgramUniform1iv(
  program: GLuint, location: GLint, count: GLsizei, value: *const GLint,
) -> () {
  let u: usize =
    glProgramUniform1iv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform1ui(
  program: GLuint, location: GLint, v0: GLuint,
) -> () {
  let u: usize =
    glProgramUniform1ui_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glProgramUniform1uiv(
  program: GLuint, location: GLint, count: GLsizei, value: *const GLuint,
) -> () {
  let u: usize =
    glProgramUniform1uiv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform2f(
  ...
  let u: usize =
    glProgramUniform2f_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform2fv(
  ...
  let u: usize =
    glProgramUniform2fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform2i(
  program: GLuint, location: GLint, v0: GLint, v1: GLint,
) -> () {
  let u: usize =
    glProgramUniform2i_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glProgramUniform2iv(
  ...
  let u: usize =
    glProgramUniform2iv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform2ui(
  ...
  let u: usize =
    glProgramUniform2ui_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glProgramUniform2uiv(
  ...
  let u: usize =
    glProgramUniform2uiv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform3f(
  ...
  let u: usize =
    glProgramUniform3f_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform3fv(
  ...
  let u: usize =
    glProgramUniform3fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform3i(
  ...
  let u: usize =
    glProgramUniform3i_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform3iv(
  ...
  let u: usize =
    glProgramUniform3iv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform3ui(
  ...
  let u: usize =
    glProgramUniform3ui_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform3uiv(
  ...
  let u: usize =
    glProgramUniform3uiv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform4f(
  ...
  let u: usize =
    glProgramUniform4f_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform4fv(
  ...
  let u: usize =
    glProgramUniform4fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform4i(
  ...
  let u: usize =
    glProgramUniform4i_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform4iv(
  ...
  let u: usize =
    glProgramUniform4iv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform4ui(
  ...
  let u: usize =
    glProgramUniform4ui_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniform4uiv(
  ...
  let u: usize =
    glProgramUniform4uiv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix2fv(
  program: GLuint, location: GLint, count: GLsizei, transpose: GLboolean,
  value: *const GLfloat,
) -> () {
  let u: usize =
    glProgramUniformMatrix2fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix2x3fv(
  ...
  let u: usize =
    glProgramUniformMatrix2x3fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix2x4fv(
  ...
  let u: usize =
    glProgramUniformMatrix2x4fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix3fv(
  ...
  let u: usize =
    glProgramUniformMatrix3fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix3x2fv(
  ...
  let u: usize =
    glProgramUniformMatrix3x2fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix3x4fv(
  ...
  let u: usize =
    glProgramUniformMatrix3x4fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix4fv(
  ...
  let u: usize =
    glProgramUniformMatrix4fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix4x2fv(
  ...
  let u: usize =
    glProgramUniformMatrix4x2fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glProgramUniformMatrix4x3fv(
  ...
  let u: usize =
    glProgramUniformMatrix4x3fv_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
static glPushDebugGroupKHR_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glPushDebugGroupKHR(
  ...
  let u: usize =
    glPushDebugGroupKHR_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLuint,
...
pub unsafe fn glReleaseShaderCompiler() -> () {
  let u: usize =
    glReleaseShaderCompiler_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn() -> () =
    unsafe { core::mem::transmute(u) };
  _func_p()
...
pub unsafe fn glResumeTransformFeedback() -> () {
  let u: usize =
    glResumeTransformFeedback_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn() -> () =
    unsafe { core::mem::transmute(u) };
  _func_p()
...
static glShaderBinary_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glShaderBinary(
  count: GLsizei, shaders: *const GLuint, binaryFormat: GLenum,
  binary: *const void, length: GLsizei,
) -> () {
...
static glTexStorage2D_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
...
pub unsafe fn glTexStorage2DMultisample(
  ...
  let u: usize =
    glTexStorage2DMultisample_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLenum,
    GLsizei,
...
static glTexStorage3D_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
...
pub unsafe fn glUseProgramStages(
  pipeline: GLuint, stages: GLbitfield, program: GLuint,
) -> () {
  let u: usize =
    glUseProgramStages_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
pub unsafe fn glValidateProgramPipeline(pipeline: GLuint) -> () {
  let u: usize =
    glValidateProgramPipeline_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLuint) -> () =
    unsafe { core::mem::transmute(u) };
  _func_p(pipeline)
...
pub unsafe fn glVertexAttribBinding(
  attribindex: GLuint, bindingindex: GLuint,
) -> () {
  let u: usize =
    glVertexAttribBinding_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLuint, GLuint) -> () =
    unsafe { core::mem::transmute(u) };
...
pub unsafe fn glVertexAttribFormat(
  attribindex: GLuint, size: GLint, type_: GLenum, normalized: GLboolean,
  relativeoffset: GLuint,
) -> () {
  let u: usize =
    glVertexAttribFormat_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(
    GLuint,
    GLint,
...
pub unsafe fn glVertexAttribIFormat(
  attribindex: GLuint, size: GLint, type_: GLenum, relativeoffset: GLuint,
) -> () {
  let u: usize =
    glVertexAttribIFormat_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
...
static glVertexBindingDivisor_p: core::sync::atomic::AtomicUsize =
  core::sync::atomic::AtomicUsize::new(0);
#[inline]
pub unsafe fn glVertexBindingDivisor(
  bindingindex: GLuint, divisor: GLuint,
) -> () {
  let u: usize =
    glVertexBindingDivisor_p.load(core::sync::atomic::Ordering::Acquire);
  assert!(u != 0);
  let _func_p: unsafe extern "system" fn(GLuint, GLuint) -> () =
    unsafe { core::mem::transmute(u) };
